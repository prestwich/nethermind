...
namespace Nethermind.Evm.Precompiles.Bls377.Shamatar
{
    ...
    /// </summary>
    public class Bls377G1MultiExpPrecompile : IPrecompile
    {
        public static IPrecompile Instance = new Bls377G1MultiExpPrecompile();

        private Bls377G1MultiExpPrecompile()
        {
        }
        ...
        public long DataGasCost(byte[] inputData, IReleaseSpec releaseSpec)
        {
            ...
            return 12000L * k * Bls377Discount.For(k) / 1000;
        }
        ...
        public (byte[], bool) Run(byte[] inputData)
        {
            ...
            bool success = ShamatarLib.Bls377G1MultiExp(inputData, output);
            if (success)
            {
