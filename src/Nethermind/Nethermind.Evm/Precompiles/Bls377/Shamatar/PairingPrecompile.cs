...
namespace Nethermind.Evm.Precompiles.Bls377.Shamatar
{
    ...
    /// </summary>
    public class Bls377PairingPrecompile : IPrecompile
    {
        private const int PairSize = 384;

        private Bls377PairingPrecompile() { }
        
        public Address Address { get; } = Address.FromNumber(16);
        
        public static IPrecompile Instance = new Bls377PairingPrecompile();
        ...
        public (byte[], bool) Run(byte[] inputData)
        {
            ...
            bool success = ShamatarLib.Bls377Pairing(inputData, output);
            if (success)
            {
