...
namespace Nethermind.Evm.Precompiles.Bls377.Shamatar
{
    ...
    /// </summary>
    public class Bls377G1AddPrecompile : IPrecompile
    {
        public static IPrecompile Instance = new Bls377G1AddPrecompile();

        private Bls377G1AddPrecompile()
        {
        }
        ...
        {
            const int expectedInputLength = 4 * Bls377Params.LenFp;
